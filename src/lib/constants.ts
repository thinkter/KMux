...
export const TRANSITION_CANVAS = '850ms cubic-bezier(0.25, 1, 0.5, 1)';
export const TRANSITION_UI = '1000ms ease';
 ...
 */
export const WIDTH_CYCLE: ('1/3' | '1/2' | '2/3' | '1')[] = ['1', '2/3', '1/2', '1/3'];
